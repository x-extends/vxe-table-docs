  ...
  <div class="code-light">
    ...
    <div class="example-code">
      <div class="example-btns">
        ...
        <vxe-button mode="text" :loading="loading" :icon="showJsCode ? 'vxe-icon-eye-fill' : 'vxe-icon-eye-fill-close'" @click="toggleVisible">{{ $t(showJsCode ? 'app.body.button.hideCode' : 'app.body.button.showJsCode') }}</vxe-button>
      </div>
...
const gitBaseUrl = 'https://github.com/x-extends/vxe-table-docs/tree/main/other3'
