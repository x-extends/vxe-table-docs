  ...
  <div>
    ...
    <div class="content" style="padding-top: 50px">
      <div style="float: left;">
        ...
        <img :src="`${resBaseUrl}/resource/donation/qq1.png`">
        <img :src="`${resBaseUrl}/resource/donation/qq2.png`">
      </div>
      <div style="float: right;">
        ...
        <div v-if="supportAuthor === '2'">
          ...
          <div style="margin-top: 38px;font-size: 18px;">感谢您的支持，送一份 <a class="link" href="https://vxeui.com/demo/vxe-ui-renderer-vue3-vite" target="_blank">渲染器详细教程文档</a>（<a class="link" href="https://api.vxeui.com/store/api/pub/vxeui/sponsor/demo/download?name=vxe-ui-renderer-vue3-vite" target="_blank">点击下载 vxe-table v4.7+ 版本</a>） ，所有支持过的用户都可以下载查看。</div>
        </div>
      </div>
    </div>
  </div>
