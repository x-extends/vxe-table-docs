<template>
  <div>
    ...
    <demo-block>
      ...
      <template v-slot:highlight>
        <pre><pre-code class="xml">{{ demoCodes[1] }}</pre-code></pre>
      </template>
    </demo-block>
    ...
    <demo-block>
      ...
      <template v-slot:highlight>
        <pre><pre-code class="xml">{{ demoCodes[2] }}</pre-code></pre>
      </template>
    </demo-block>
    ...
    <demo-block>
      ...
      <template v-slot:highlight>
        <pre><pre-code class="xml">{{ demoCodes[3] }}</pre-code></pre>
      </template>
    </demo-block>
    ...
    <demo-block>
      ...
      <template v-slot:highlight>
        <pre><pre-code class="xml">{{ demoCodes[4] }}</pre-code></pre>
      </template>
    </demo-block>
