<template>
  <div>
    ...
    <vxe-toolbar>
      <template #buttons>
        <vxe-button @click="$refs.xTable.toggleTreeExpand(demo1.tableData[1], true)">切换第一个</vxe-button>
        <vxe-button @click="$refs.xTable.setTreeExpand(demo1.tableData[8], true)">展开第三个</vxe-button>
