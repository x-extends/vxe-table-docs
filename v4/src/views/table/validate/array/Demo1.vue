...
import { ref } from 'vue'
import { VxeUI, VxeTableInstance, VxeTablePropTypes, VxeColumnPropTypes, VxeSelectProps } from 'vxe-table'
...
const roleListEditRender = ref<VxeColumnPropTypes.EditRender<RowVO, VxeSelectProps>>({
  name: 'VxeSelect',
  props: {
    multiple: true
  },
