<template>
  <div>
    <vxe-table
      ...
      <vxe-column field="address" title="多行文本溢出省略" width="400" :cell-render="addressCellRender"></vxe-column>
    </vxe-table>
  </div>
</template>
...
import type { VxeTextEllipsisProps } from 'vxe-pc-ui'
...
const addressCellRender = reactive<VxeColumnPropTypes.CellRender<RowVO, VxeTextEllipsisProps>>({
