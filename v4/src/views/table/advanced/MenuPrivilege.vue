    ...
    const demo1 = reactive({
      ...
      tableMenu: {
        ...
        body: {
          options: [
            [
              { code: 'details', name: '查看详情', prefixIcon: 'vxe-icon--question', visible: true, disabled: false }
            ],
            [
              { code: 'copy', name: 'app.body.label.copy', prefixIcon: 'vxe-icon--question', visible: true, disabled: false },
              { code: 'clear', name: '清除内容', prefixIcon: 'vxe-icon--question', visible: true, disabled: false }
            ],
            [
