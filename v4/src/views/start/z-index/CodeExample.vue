<template>
  <div>
    <CodeLight>
      <template #tip>
        <vxe-tip status="primary" title="动态 z-index 调整">
        ...
        <vxe-tip status="success">
          Vxe 组件使用 <vxe-link href="https://www.npmjs.com/package/dom-zindex" target="_blank" status="primary">dom-zindex</vxe-link> 规范共享 z-index，对于多个组件库共用的场景将非常有用；例如第三方组件的弹窗和表格，在弹窗显示是动态设置一下 domZIndex.setCurrent(xxx) 就可以达到互相兼容的效果。
        </vxe-tip>
      </template>
