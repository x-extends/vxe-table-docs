<template>
  <div>
    <CodeLight>
      ...
      <template #use>
        <iframe :src="cdnUrl" style="display: block;width: 100%;height: 620px;border: 1px solid #000;"></iframe>
...
const cdnUrl = computed(() => {
  return `${resBaseUrl.value}/resource/useCdn/vxe-gantt-v${docsVersion.value}.html?v=${import.meta.env.VITE_APP_DATE_NOW}`
})
