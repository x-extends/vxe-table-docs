    ...
    <CodeLight>
      ...
      <template #use>
        <div>
          ...
          <vxe-link status="primary" href="https://github.com/xuliangzhan/vxe-table-demo/tree/master/vxe-table-by-vue3-vite-import" target="_blank">示例项目</vxe-link>
        </div>
        <pre>
