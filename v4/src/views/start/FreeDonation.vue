<template>
  <div>
    ...
    <vxe-tip :title="appStore.pageTitle" status="primary">
      <div><vxe-link status="primary" :href="`https://github.com/x-extends/${appStore.packName}`" target="_blank">{{ appStore.pageTitle }}</vxe-link> 是 MIT开源的。为了使项目能够健康持续的发展下去，您可以通过下方扫码来支持作者。</div>
    </vxe-tip>
