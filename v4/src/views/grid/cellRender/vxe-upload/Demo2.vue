...
const imgList3CellRender = reactive<VxeColumnPropTypes.CellRender<RowVO, VxeUploadProps>>({
  name: 'VxeUpload',
  props: {
    mode: 'image',
    readonly: true,
...
const imgList4CellRender = reactive<VxeColumnPropTypes.CellRender<RowVO, VxeUploadProps>>({
  name: 'VxeUpload',
  props: {
    mode: 'image',
    multiple: true,
...
const gridOptions = reactive<VxeGridProps<RowVO>>({
  ...
  columns: [
    ...
    { field: 'fileList3', title: '精简列表', width: 100, cellRender: imgList3CellRender },
