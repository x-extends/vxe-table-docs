<template>
  <div>
    ...
    <CodeLight path="grid/base/autoWidth/Demo3">
      <template #tip>
        <vxe-tip status="primary">
          对于某些场景，如果希望只对单元格进行自适应列宽，而列头保持自动换行不做设置，可以通过 <ApiLink name="grid" prop="column-config"/>.<ApiLink name="grid" prop="auto-options"/> 来控制
        </vxe-tip>
      </template>
    </CodeLight>
  </div>
