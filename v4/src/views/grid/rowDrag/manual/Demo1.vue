...
import type { VxeGridProps, VxeGridInstance, VxeWithRequired } from 'vxe-table'
...
const gridOptions = reactive<VxeWithRequired<VxeGridProps<RowVO>, 'data'>>({
  ...
  data: [
    ...
    { id: 10004, name: 'Test4', role: 'Designer', sex: 'Women', age: 24, address: 'Guangzhou' },
    { id: 10005, name: 'Test5', role: 'PM', sex: 'Man', age: 42, address: 'test abc' },
    { id: 10006, name: 'Test6', role: 'Test', sex: 'Women', age: 39, address: 'Shanghai' }
  ]
})
