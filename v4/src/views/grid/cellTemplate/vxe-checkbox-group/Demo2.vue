...
const gridOptions = reactive<VxeGridProps<RowVO>>({
  ...
  columns: [
    ...
    { field: 'name', title: 'Name', minWidth: 200 },
    {
      ...
      slots: {
        default ({ row }) {
          return <vxe-checkbox-group v-model={row.hobbyList1} options={hobbyOptions.value}></vxe-checkbox-group>
        }
      }
    },
    {
      ...
      slots: {
        default ({ row }) {
          return <vxe-checkbox-group v-model={row.hobbyList2} options={hobbyOptions.value}></vxe-checkbox-group>
        }
      }
    }
  ],
