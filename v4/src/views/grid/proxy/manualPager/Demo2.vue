...
import type { VxeGridInstance, VxeGridProps, VxeGridListeners, VxeWithRequired } from 'vxe-table'
...
const gridOptions = reactive<VxeWithRequired<VxeGridProps<RowVO>, 'pagerConfig'>>({
  border: true,
  height: 300,
  pagerConfig: {
    currentPage: 1,
