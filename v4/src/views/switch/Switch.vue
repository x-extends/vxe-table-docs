<template>
  <div>
    ...
    <demo-block>
      <template v-slot:source>
        <p>
          <vxe-switch v-model="demo1.value13" open-icon="vxe-icon-question-circle-fill" close-icon="vxe-icon-question-circle-fill"></vxe-switch>
          <vxe-switch v-model="demo1.value14" open-label="app.body.label.on" close-label="app.body.label.off" open-icon="vxe-icon-question-circle-fill" close-icon="vxe-icon-question-circle-fill"></vxe-switch>
      ...
      <template v-slot:highlight>
        <pre><pre-code class="xml">{{ demoCodes[2] }}</pre-code><pre-code class="javascript">{{ demoCodes[3] }}</pre-code></pre>
      </template>
    </demo-block>
