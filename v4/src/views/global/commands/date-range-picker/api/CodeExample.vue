<template>
  <div>
    <vxe-tip status="primary" title="全局指令">将日期范围选择器快捷按钮的指令注册成全局可复用</vxe-tip>
...
const tableData = ref([
  {
    ...
    list: [
      {
        name: 'dateRangePickerCommandMethod',
        desc: '日期范围选择器 - 自定义日期范围快捷按钮指令方法',
        version: '4.6.0',
        type: '',
        enum: '',
        defVal: '({ code, option, $datePicker }) => void',
        list: []
      }
    ]
  },
