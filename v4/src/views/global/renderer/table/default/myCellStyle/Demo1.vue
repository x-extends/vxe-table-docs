<template>
  <div>
    <vxe-table
      ...
      <vxe-column field="amount" title="Amount" :formatter="formatterAmount" :cell-render="{name: 'MyTableCellStyle'}"></vxe-column>
    </vxe-table>
  </div>
</template>
...
const formatterAmount: VxeColumnPropTypes.Formatter<RowVO> = ({ cellValue }) => {
