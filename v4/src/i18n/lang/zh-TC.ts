  ...
  app: {
    ...
    body: {
      ...
      other: {
        ...
        v3: 'v3+ (vue 2.6 < 3 長期維護版)',
        v3d5: '3.5+ (vue 2.6 < 3 粘性表格)',
        v4: 'v4+ (vue 3.2 < 4 最新穩定版)',
        v4d5: '4.5+ (vue 3.2 < 4 粘性表格)',
        plan: {
          v1: 'v1 基於 vue2.6 < 3，支持所有主流的瀏覽器，實現表格的一切實用的功能',
          v2: 'v2 基於 vue2.6 < 3，支持所有主流的瀏覽器，同時兼具功能與效能',
          v3: 'v3 基於 vue2.6 < 3，支持現代瀏覽器並部分相容IE11，提升渲染效能',
          v4: 'v4 基於 vue3.2 < 4，只支持現代瀏覽器，不支持IE'
        },
        compatibility: '相容性變動',
        releases: '更新日誌',
        donation: '支持我们',
