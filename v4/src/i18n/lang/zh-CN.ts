export default {
  app: {
    ...
    body: {
      ...
      other: {
        v1: 'v1+ (vue 2.6 < 3 停止维护) ~ 2020-04 停止更新',
        v2: 'v2+ (vue 2.6 < 3 停止维护) ~ 2021-12 停止更新',
        v3: 'v3+ (vue 2.6 < 3 长期维护版)',
        v3d5: '3.5+ (vue 2.6 < 3 粘性表格)',
        v4: 'v4+ (vue 3.2 < 4 最新稳定版)',
        v4d5: '4.5+ (vue 3.2 < 4 粘性表格)',
        plan: {
          v1: 'v1 基于 vue2.6 < 3，支持所有主流的浏览器，实现表格的一切实用的功能',
          v2: 'v2 基于 vue2.6 < 3，支持所有主流的浏览器，同时兼具功能与性能',
          v3: 'v3 基于 vue2.6 < 3，支持现代浏览器并部分兼容 IE11，提升渲染性能',
          v4: 'v4 基于 vue3.2 < 4，只支持现代浏览器，不支持 IE'
        },
        compatibility: '兼容性变动',
        releases: '更新日志',
        donation: '支持我们',
