  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'strict', name: 'ComponentGridCurrentRowStrict', component: () => import('@/views/grid/currentRow/strict/CodeExample.vue') }
      ]
    },
    {
      path: 'rowResizable',
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'width', name: 'ComponentGridMenuWidth', component: () => import('@/views/grid/menu/width/CodeExample.vue') },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'autoIncrement', name: 'ComponentGridOtherAutoIncrement', component: () => import('@/views/grid/other/autoIncrement/CodeExample.vue') },
        {
          path: 'reverse',
