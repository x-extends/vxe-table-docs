    ...
    list: [
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            desc: '自定义激活编辑之前逻辑，该方法的返回用来决定该单元格是否允许编辑',
            version: '4.2.5',
            type: '({ row, rowIndex, column, columnIndex }) => boolean',
            enum: '',
            defVal: '',
      ...
      },
      {
        ...
        list: [
          ...
          // {
          //   name: 'attrs',
          //   desc: '渲染的属性（请查看自定义渲染的 Attribute）',
          //   version: '',
          //   type: 'any',
          //   enum: '',
          //   defVal: '',
          ...
          // {
          //   name: 'events',
          //   desc: '渲染组件的事件（请查看自定义渲染的 Events）',
          //   version: '',
          //   type: 'any',
          //   enum: '',
          //   defVal: '{}, ...[目自定义渲染的 arguments]',
          //   list: []
          // },
          // {
          //   name: 'nativeEvents',
          //   desc: '渲染组件的原生事件（请查看自定义渲染的 Events）',
          //   version: '',
          //   type: 'any',
          //   enum: '',
          //   defVal: '{}, ...[自定义渲染的 arguments]',
          //   list: []
          }
        ]
      },
      ...
      },
      {
        ...
        list: [
          ...
          {
            name: 'checkMethod',
            desc: '自定义列是否允许选中的方法，该方法的返回值用来决定这一列的 checkbox 是否可以选中',
            version: '',
            type: '({ column }) => boolean',
            enum: '',
            defVal: '',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        desc: '用于 checkbox-config.reserve，获取已保留选中的行数据，不包含当前列表（如果 isFull=true 不包含完整列表）',
        version: '',
        type: 'Array<Row>',
        enum: '',
        defVal: '',
