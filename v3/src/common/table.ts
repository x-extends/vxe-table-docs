  ...
  children: [
      ...
      children: [
        ...
        { title: 'Toolbar API', isSelfAPI: true, routerLink: { name: 'DocsApi', params: { name: 'toolbar' } } },
        {
          ...
          children: [
            ...
            { title: '自适应单元格高度', routerLink: { name: 'ComponentTableBaseAutoBreak' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentTableCellTemplateVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentTableEditRenderVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentTableEditTemplateVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '复制粘贴与数据校验', isEnterprise: true, routerLink: { name: 'EnterprisePreview', params: { previewCode: 'table_extend_cell_area_edit_valid' }, query: { previewPath: '%2FextendCellArea%2Ftable%2Fedit%2Fvalid' } } },
            {
              title: '自定义插槽模板',
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '导出 XLSX 格式', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-xlsx/table/export`, linkTarget: '_blank' },
            { title: '导出 PDF 格式', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-pdf/table/export`, linkTarget: '_blank' },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '导入 XLSX 格式', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-xlsx/table/import`, linkTarget: '_blank' },
      ...
      children: [
        { title: 'Grid API', isSelfAPI: true, routerLink: { name: 'DocsApi', params: { name: 'grid' } }, keywords: 'vxe-grid' },
        {
          ...
          children: [
            ...
            { title: '自适应单元格高度', routerLink: { name: 'ComponentGridBaseAutoBreak' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '集成第三方扩展插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-render-element/grid/filter/el-input`, linkTarget: '_blank' }
          ]
        },
        {
          title: '筛选 - 渲染 - 插槽式',
        ...
        },
        {
          ...
          children: [
            ...
            { title: '设置宽度', routerLink: { name: 'ComponentGridMenuWidth' } },
            { title: '自定义样式', routerLink: { name: 'ComponentGridMenuClassName' } },
            { title: '便捷配置 Code 插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-menu/grid/full`, linkTarget: '_blank' }
          ]
        },
        {
          title: '查询表单',
        ...
        },
        {
          ...
          children: [
            ...
            { title: '自定义第三方图标', isPlugin: true, linkUrl: `${otherUrl}#/other-iconfont/font-class/toolbar/icons`, linkTarget: '_blank' },
            {
              title: '自定义插槽模板',
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentGridCellTemplateVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '实现复选框启用编辑', routerLink: { name: 'ComponentGridEditCheckboxCol' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentGridEditRenderVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: 'VxeInput 单行输入框', routerLink: { name: 'ComponentGridEditTemplateVxeInput' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '复制粘贴与数据校验', isEnterprise: true, routerLink: { name: 'EnterprisePreview', params: { previewCode: 'table_extend_cell_area_edit_valid' }, query: { previewPath: '%2FextendCellArea%2Fgrid%2Fedit%2Fvalid' } } },
            {
              title: '自定义插槽模板',
              children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '导出 XLSX 格式', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-xlsx/grid/export`, linkTarget: '_blank' },
            { title: '导出 PDF 格式', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-pdf/grid/export`, linkTarget: '_blank' },
            ...
            { title: '弹窗参数', routerLink: { name: 'ComponentGridExportModelOptions' } },
            { title: '功能设置', routerLink: { name: 'ComponentGridExportSettingOptions' } },
            ...
            { title: '禁止勾选列', routerLink: { name: 'ComponentGridExportCheckMethod' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '弹窗参数', routerLink: { name: 'ComponentGridPrintModelOptions' } },
            { title: '功能设置', routerLink: { name: 'ComponentGridPrintSettingOptions' } },
            { title: '指定列', routerLink: { name: 'ComponentGridPrintColumns' } },
            { title: '禁止勾选列', routerLink: { name: 'ComponentGridPrintCheckMethod' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '设置不同行高 + 自适应行高', routerLink: { name: 'ComponentGridScrollSetRowHeight' } },
        ...
        },
        {
          ...
          children: [
            ...
            { title: '实现表格穿梭框选择', routerLink: { name: 'ComponentGridOtherTableTransfer' } },
            { title: '树形实现子节点自定义表头', routerLink: { name: 'ComponentGridOtherTreeSubCols' } },
            { title: '实现产品对比表', routerLink: { name: 'ComponentGridOtherCompareTable' } },
            { title: '实现复杂的分组列和数据合并大类', routerLink: { name: 'ComponentGridOtherRowColMerge' } }
          ]
        }
      ]
    },
    {
      ...
      children: [
        ...
        { title: '数据校验插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-validator/table/base`, linkTarget: '_blank' },
        { title: '导出 XLSX 插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-xlsx/table/export`, linkTarget: '_blank' },
        { title: '导出 PDF 插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-export-pdf/table/export`, linkTarget: '_blank' },
        { title: '更多第三方扩展插件', isPlugin: true, linkUrl: `${otherUrl}`, linkTarget: '_blank' }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { title: '便捷校验配置插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-validator/table/base`, linkTarget: '_blank' }
      ]
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '集成第三方扩展插件', isPlugin: true, linkUrl: `${otherUrl}#/plugin-render-element/table/filter/el-input`, linkTarget: '_blank', keywords: 'filter-render' },
            { title: '更多筛选插件', isEnterprise: true, linkUrl: 'https://vxetable.cn/plugins/', linkTarget: '_blank' }
          ]
        },
        {
          title: '空数据提示',
