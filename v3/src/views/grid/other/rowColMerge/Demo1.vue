...
export default Vue.extend({
  ...
  methods: {
     ...
     */
    calculateMergeCells (list: RowVO[], levelKeys: string[]) {
      const mergeCells: VxeTablePropTypes.MergeCells<RowVO> = []
      ...
      const processGroup = (start: number, col: number) => {
    ...
    loadList () {
      ...
      setTimeout(() => {
        ...
        this.gridOptions.mergeCells = this.calculateMergeCells(list, ['categoryLevel1', 'categoryLevel2', 'categoryLevel3'])
