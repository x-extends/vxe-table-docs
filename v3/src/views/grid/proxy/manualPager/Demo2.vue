...
<script lang="ts">
import Vue from 'vue'
import type { VxeGridInstance, VxeGridProps, VxeGridPropTypes, VxeWithRequired } from 'vxe-table'
...
export default Vue.extend({
  data () {
    const gridOptions: VxeWithRequired<VxeGridProps<RowVO>, 'pagerConfig'> = {
      border: true,
      height: 500,
      pagerConfig: {
        currentPage: 1,
