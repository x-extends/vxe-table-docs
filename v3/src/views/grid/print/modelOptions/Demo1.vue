<template>
  <div>
    ...
    全屏打开：<vxe-switch v-model="printConfig.modelOptions.fullscreen"></vxe-switch>
...
export default Vue.extend({
  data () {
    const printConfig: VxeWithRequired<VxeTablePropTypes.PrintConfig<RowVO>, 'modelOptions'> = {
      modelOptions: {
        title: '正在打印',
        width: 1000,
        height: 600,
