...
export default Vue.extend({
  data () {
    ...
    const avatarUrlCellRender: VxeColumnPropTypes.CellRender<RowVO, VxeUploadProps> = {
      name: 'VxeUpload',
      props: {
        mode: 'image',
        singleMode: true,
    ...
    const cityEditRender: VxeColumnPropTypes.EditRender<RowVO, VxeSelectProps> = {
      name: 'VxeSelect',
      options: [
        { label: '深圳市', value: 'sz' },
        { label: '广州市', value: 'gz' },
