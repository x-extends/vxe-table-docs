...
<script lang="ts">
import Vue from 'vue'
import { VxeGridProps, VxeGridPropTypes, VxeColumnPropTypes } from 'vxe-table'
...
export default Vue.extend({
  data () {
    const productUrlCellRender: VxeColumnPropTypes.CellRender = {
      name: 'VxeImage',
      props: {
        width: 100,
        height: 100
    ...
    const subGridOptions: VxeGridProps<RowVO> = {
      border: true,
      showOverflow: true,
      columns: [
  ...
  methods: {
    ...
    updateFooterCount () {
      this.countRow.productName = XEUtils.random(9999, 999999)
      this.countRow.productAmount = XEUtils.random(9999, 999999)
    }
  }
})
</script>
