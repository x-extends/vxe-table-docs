<template>
  <div>
    <p class="tip">
      ...
      配置参数：<br>
      cellClassName: string | (params: { row, rowIndex, $rowIndex, column, columnIndex, $columnIndex, _columnIndex, $table }) => string 单元格单项className<br>
      ...
      renderHeader (h, renderOpts, params: { column, columnIndex, $columnIndex, _columnIndex, $rowIndex, $table }) 表头单元格显示内容<br>
      renderDefault (h, renderOpts, params: { row, rowIndex, $rowIndex, column, columnIndex, $columnIndex, _columnIndex, $table }) 单元格显示默认内容<br>
      renderFooter (h, renderOpts, params: { row, rowIndex, $rowIndex, column, columnIndex, $columnIndex, _columnIndex, $rowIndex, items, itemIndex, $table }) 表尾单元格显示内容<br>
      ...
      demoCodes: [
        ...
        VXETable.renderer.add('MyLink', {
          ...
          renderDefault (h, renderOpts, params) {
            ...
            return <a class="my-link" onClick={ () => events.click(params) }>{row[column.property]}</a>
          },
          // 导出模板，例如导出插槽中自定义的内容
          exportMethod (params) {
