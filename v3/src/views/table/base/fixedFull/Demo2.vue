...
export default Vue.extend({
  data () {
    ...
    const colFixeds: Record<string, VxeColumnPropTypes.Fixed> = {
      col0: '',
      col1: '',
      col4: '',
      col5: ''
  ...
  methods: {
    toggleFixedColumn (prop: string, type: VxeColumnPropTypes.Fixed) {
      this.colFixeds[prop] = this.colFixeds[prop] ? null : type
    }
  }
})
</script>
