<template>
  <div>
    <vxe-table
      ...
      <vxe-column field="sex" title="Sex" width="300" :cell-render="sexCellRender"></vxe-column>
    </vxe-table>
  </div>
</template>
...
export default Vue.extend({
  data () {
    const tableData: RowVO[] = [
      ...
      { id: 10004, name: 'Test4', role: 'Test', sex: ['1'] },
      { id: 10005, name: 'Test5', role: 'Develop', sex: ['1', '0'] }
    ]
