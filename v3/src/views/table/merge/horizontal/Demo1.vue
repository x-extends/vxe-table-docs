...
export default Vue.extend({
  ...
  methods: {
    ...
    check4ChangeEvent (row: any, checked: boolean) {
      let childList = this.tableData.filter(item => item.id3 === row.id3 && item.name4 === row.name4)
      childList.forEach(item => {
        item.check4 = checked
      })
      childList = this.tableData.filter(item => item.id3 === row.id3)
    ...
    check3ChangeEvent (row: any, checked: boolean) {
      let childList = this.tableData.filter(item => item.id2 === row.id2 && item.name3 === row.name3)
      childList.forEach(item => {
        item.check3 = checked
      })
      childList = this.tableData.filter(item => item.id3 === row.id3)
    ...
    check2ChangeEvent (row: any, checked: boolean) {
      let childList = this.tableData.filter(item => item.id1 === row.id1 && item.name2 === row.name2)
      childList.forEach(item => {
        item.check2 = checked
      })
      childList = this.tableData.filter(item => item.id2 === row.id2)
    ...
    check1ChangeEvent (row: any, checked: boolean) {
      let childList = this.tableData.filter(item => item.name1 === row.name1)
      childList.forEach(item => {
        item.check1 = checked
      })
      childList = this.tableData.filter(item => item.id1 === row.id1)
