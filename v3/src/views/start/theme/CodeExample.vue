    ...
    <CodeLight>
      <template #tip>
        <vxe-tip status="primary" title="自定义 scss 变量">
          通过修改 scss 变量（<vxe-link href="https://gitee.com/xuliangzhan/vxe-table/blob/master/styles/variable.scss" status="primary" target="_blank">查看全部变量</vxe-link>）方式修改组件样式，示例：
        </vxe-tip>
      </template>
