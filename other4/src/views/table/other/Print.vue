<template>
  <div>
    <p class="tip">
      内置打印模块：可以非常简单将任何视图直接输出打印，可以通过 print-config.content 或者 print-config.beforePrintMethod 自定义内容模板<br>
...
export default defineComponent({
  setup () {
    ...
    const printEvent3 = () => {
      ...
      `
      // 生成二维码
      QRCode.toDataURL('https://gitee.com/x-extends/vxe-table').then(url => {
        // 打印模板
        const printTmpl = `
