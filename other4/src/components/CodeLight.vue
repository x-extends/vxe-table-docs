  ...
  <div class="code-light">
    ...
    <div class="example-code">
      <div class="example-btns">
        ...
        <vxe-button class="example-btn" mode="text" :loading="jsLoading" :disabled="showTsCode" :icon="showJsCode ? 'vxe-icon-eye-fill' : 'vxe-icon-eye-fill-close'" @click="toggleJsVisible">{{ $t(showJsCode ? 'app.body.button.hideCode' : 'app.body.button.showJsCode') }}</vxe-button>
        <vxe-button class="example-btn" mode="text" :loading="tsLoading" :disabled="showJsCode" :icon="showTsCode ? 'vxe-icon-eye-fill' : 'vxe-icon-eye-fill-close'" @click="toggleTsVisible">{{ $t(showTsCode ? 'app.body.button.hideCode' : 'app.body.button.showTsCode') }}</vxe-button>
      </div>
...
const gitBaseUrl = 'https://github.com/x-extends/vxe-table-docs/tree/main/other4'
