export default {
  app: {
    ...
    body: {
      ...
      other: {
        v1: 'v1.x (vue 2.6 停止維護) ~ 2020-04 停止更新',
        v2: 'v2.x (vue 2.6 停止維護) ~ 2021-12 停止更新',
        v3d8: 'v3.0~3.8 (vue 2.6 長期維護版) ~ 2024-12 停止更新',
        v3: 'v3.9+ (vue 2.6 長期維護版)',
        v4d6: 'v4.0~4.6 (vue 3.x 長期維護版) ~ 2024-12 停止更新',
        v4: 'v4.7+ (vue 3.x 最新版)',
        plan: {
    ...
    api: {
      ...
      tableColumn: {
        desc: {
          ...
          title: '列标题（支持开启国际化）',
          width: '列宽度，如果为空则均匀分配剩余宽度，如果为auto，则自适应内容宽度（当全部列都固定宽度时，可能会存在宽屏下不会铺满，可以设置部分列为 "%" 百分比或者通过 "min-width" 最小宽度设置）',
