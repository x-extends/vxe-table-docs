  ...
  app: {
    ...
    body: {
      ...
      other: {
        ...
        v3d8: 'v3.0~3.8 (vue 2.6 停止维护) ~ 2024-12 停止更新',
        v3: 'v3.9+ (vue 2.6 长期维护版)',
        v4d6: 'v4.0~4.6 (vue 3.x 停止维护) ~ 2024-12 停止更新',
        v4: 'v4.7+ (vue 3.x 最新版)',
        plan: {
    ...
    footer: {
      donation: '支持我们',
      donationDesc: 'vxe-table 是 MIT开源的，无论是个人还是企业商用都是使用完全免费的。为了使项目能够健康持续的发展下去，您可以通过下方扫码来支持作者。'
    },
    api: {
      apiSearch: 'API 搜索',
      title: {
