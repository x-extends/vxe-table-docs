<template>
  <div>
    ...
    <p class="tip">
      默认选中，通过指定 <table-api-link prop="checkRowKeys"/> 设置默认选中的行，指定默认值需要有 <table-api-link prop="row-config"/>.<table-api-link prop="keyField"/>，通过 <table-api-link prop="highlight"/> 设置高亮选中行<br>
