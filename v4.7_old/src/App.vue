    ...
    <header class="page-header">
      ...
      <div class="right">
        <div class="content">
          ...
          <vxe-select class="version-switch" size="mini" v-model="appData.version2" :options="sysVersionOptions" @change="vChangeEvent"></vxe-select>
...
const selectSysVersion = computed(() => {
  return systemVersionList.value.find(item => item.version === appData.version2)
})
